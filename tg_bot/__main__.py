...
PM_START_TEXT = """
Hi {}, my name is {}! If you have any questions on how to use me, read /help - and then head to @Error69Talks.

I'm a group manager bot built in python3, using the python-telegram-bot library, and am fully opensource; 

Feel free to submit pull requests on github, or to contact my support group, @Error69Talks, with any bugs, questions \
or feature requests you might have :)
I also have a news channel, @Error69Talks for announcements on new features, downtime, etc.
